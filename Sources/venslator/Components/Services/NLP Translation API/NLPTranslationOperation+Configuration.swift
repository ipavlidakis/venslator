//
//  NLPTranslationOperation+Configuration.swift
//  venslator
//
    ...
    struct Configuration: Codable, ConfigurationProtocol {
        ...
        private static func extractURL(
            ...
            if let _path = path {
                ...
                result = fallback.deletingLastPathComponent()
            }
        ...
        init(
            ...
            concurrentOperations: Int = 2, // Current limitation of the NLP translation API,
